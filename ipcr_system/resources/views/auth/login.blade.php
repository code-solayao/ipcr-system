...
<head>
    ...
    <title>Sign in - IPCR System</title>
            ...
            <div class="w-full max-w-md p-8 space-y-6 bg-sky-300 border-2 rounded-2xl shadow-lg">
                ...
                <div>
                    <p class="text-sm text-center text-gray-700">
                        Create an account 
                        <a href="{{ route('view.signup') }}" class="text-blue-700 hover:underline">here</a> or 
                        <a href="{{ route('index') }}" class="text-blue-700 hover:underline">go back</a>.
                    </p>
                </div>
            </div>
        </div>
